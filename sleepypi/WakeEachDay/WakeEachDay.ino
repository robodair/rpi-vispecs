...
// Simple idea here - from whenever you press the reset button/setup the arduino,
// it will wake the pi every 24 hours until the power is no longer there
#define TIME_INTERVAL_SECONDS    0
#define TIME_INTERVAL_MINUTES    0    // i.e RPi powers up every 15 Mins   
#define TIME_INTERVAL_HOURS      0
#define TIME_INTERVAL_DAYS       1
